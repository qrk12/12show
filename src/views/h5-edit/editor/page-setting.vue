  ...
  <div>
    ...
    <el-form label-width="70px">
      ...
      <el-form-item label="背景颜色">
        <el-row>
          <el-col :span="5">
            <el-color-picker v-model="currentPageData.background.color" show-alpha @change="addHistory" />
          </el-col>
          <el-col :span="19">
...
export default {
  ...
  methods: {
    ...
    onDelete() {
      this.currentPageData.background.image.crop = null
      this.currentPageData.background.image.origin = null
      this.addHistory()
    },
